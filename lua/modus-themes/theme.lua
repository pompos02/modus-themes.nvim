...
function M.setup()
    ...
    theme.highlights = {
        ...
        BlinkCmpLabelMatch = { fg = c.green, bg = c.none },
        BlinkCmpLabelMatchFuzzy = { fg = c.green, bg = c.none },
        ...
        CmpItemKindTabNine = { fg = c.cyan_cooler, bg = c.none },
                ...
                RenderMarkdownH1Bg = { fg = c.blue },
                RenderMarkdownH2Bg = { fg = c.yellow },
                RenderMarkdownH3Bg = { fg = c.magenta },
                RenderMarkdownH4Bg = { fg = c.green },
                RenderMarkdownH5Bg = { fg = c.red },
                RenderMarkdownH6Bg = { fg = c.cyan_warmer },
                ...
                RenderMarkdownInfo = { fg = c.info, bg = c.bg_blue_nuanced },
                RenderMarkdownSuccess = { fg = c.ok, bg = c.bg_green_nuanced },
                RenderMarkdownHint = { fg = c.hint, bg = c.bg_cyan_nuanced },
                RenderMarkdownWarn = { fg = c.warning, bg = c.bg_yellow_nuanced },
                RenderMarkdownError = { fg = c.error, bg = c.bg_red_nuanced },
