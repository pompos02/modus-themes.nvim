...
M.modus_operandi = {
    ...
    green_faint = "#6ec07a",
    yellow = "#b98526",
    yellow_warmer = "#d08a2c",
    yellow_cooler = "#a18a4a",
    yellow_faint = "#e2b051",
    blue = "#1b79c5",
    blue_warmer = "#2f6fbf",
    blue_cooler = "#0f8db8",
    ...
    bg_green_intense = "#7edb73",
    bg_yellow_intense = "#f0c23a",
    bg_blue_intense = "#a9c3ff",
    bg_magenta_intense = "#d88ae8",
    bg_cyan_intense = "#86ccf3",

    -- Subtle should be combined with fg_alt, fg_main
    bg_red_subtle = "#ffc0b0",
    bg_green_subtle = "#a3ecab",
    bg_yellow_subtle = "#ffe089",
    bg_blue_subtle = "#c1d7ff",
    bg_magenta_subtle = "#f4c6f4",
    bg_cyan_subtle = "#b0e9ff",

    -- Nuanced can be combined with corresponding foreground ie. bg_red_nuanced with red
    bg_red_nuanced = "#ffe0dc",
    bg_green_nuanced = "#ddeee1",
    bg_yellow_nuanced = "#ffebce",
    bg_blue_nuanced = "#e6edff",
    bg_magenta_nuanced = "#f6e1fb",
    bg_cyan_nuanced = "#e1f4fb",
...
function M.setup(opts)
    ...
    colors.visual = colors.bg_blue_nuanced
